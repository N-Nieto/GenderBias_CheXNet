...
gsutil -m cp -r /content/GenderBias_CheXNet/Cross_validation_splits/100%_female_images gs://gender-bias-data/Cross_validation_splits
gsutil -m cp -r /content/GenderBias_CheXNet/Cross_validation_splits/0%_female_images gs://gender-bias-data/Cross_validation_splits